...
exports.sendMouseEvent = function(mouseEventType, mouseX, mouseY) {
  
  //sendEvent(mouseEventType[, mouseX, mouseY, button='left'])
  
  debug('.sendEvent() %s %s %s', mouseEventType, mouseX, mouseY);
  var self = this;
  
  //mousemove
  self.page.sendEvent(mouseEventType, text, null, null, 0);
  
};

exports.sendMouseMove = function(mouseX, mouseY) {
  
  //sendEvent(mouseEventType[, mouseX, mouseY, button='left'])
  
  debug('.sendMouseMove() %s %s',  mouseX, mouseY);
  var self = this;
  
  //mousemove
  self.page.sendEvent('mousemove', mouseX, mouse);
